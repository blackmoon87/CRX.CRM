...
class Request
{
    ...
    /**
     * Set route parameters matched by the router.
     */
    ...
    /**
     * Get route parameters matched by the router.
     */
    ...
    /**
     * Retrieve query parameter or all query parameters ($_GET).
     */
    ...
    /**
     * Retrieve a parameter from route parameters, POST, JSON payload, or GET inputs.
     */
    public function input(string $key, mixed $default = null): mixed
    {
        return $this->routeParams[$key] ?? $_POST[$key] ?? $this->getJsonParams()[$key] ?? $_GET[$key] ?? $default;
    }
    ...
    public function validateCsrf(): bool
    {
        ...
        $postToken = $_POST['_csrf'] ?? $_POST['_token'] ?? null;
        if ($postToken !== null) {
            $sessionToken = Application::$app->session->get('_csrf_token');
